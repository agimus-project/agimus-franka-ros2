        ...
        Node(
            ...
            remappings=[
                ...
                (
                    ...
                    f"{arm_id_str}_gripper/gripper_action/_action/feedback",
                ),
                (
                    "gripper_action_controller/gripper_cmd/_action/status",
                    f"{arm_id_str}_gripper/gripper_action/_action/status",
                ),
                (
                    "gripper_action_controller/gripper_cmd/_action/cancel_goal",
                    f"{arm_id_str}_gripper/gripper_action/_action/cancel_goal",
                ),
                (
                    "gripper_action_controller/gripper_cmd/_action/get_result",
                    f"{arm_id_str}_gripper/gripper_action/_action/get_result",
                ),
                (
                    "gripper_action_controller/gripper_cmd/_action/send_goal",
                    f"{arm_id_str}_gripper/gripper_action/_action/send_goal",
                ),
            ],
            output={
                "stdout": "screen",
                ...
                parameters=[
                    {
                        "source_list": [
                            ...
                            "agimus_franka_gripper/joint_states",
                        ],
                        "rate": 30,
                    }
                ],
