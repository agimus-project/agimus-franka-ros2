...
Robot::Robot(std::unique_ptr<agimus_franka::Robot> robot, std::unique_ptr<Model> model)
    : robot_(std::move(robot)), agimus_franka_hardware_model_(std::move(model)) {}

Robot::Robot(const std::string& robot_ip, const rclcpp::Logger& logger) {
  agimus_franka::RealtimeConfig rt_config = agimus_franka::RealtimeConfig::kEnforce;
...
void Robot::writeOnceEfforts(const std::array<double, 7>& efforts) {
  ...
  if (torque_command_rate_limiter_active_) {
    torque_command.tau_J =
        agimus_franka::limitRate(agimus_franka::kMaxTorqueRate, torque_command.tau_J, current_state_.tau_J_d);
  }
...
void Robot::writeOnceJointVelocities(const std::array<double, 7>& velocities) {
  ...
  if (velocity_command_rate_limit_active_) {
    velocity_command.dq = agimus_franka::limitRate(
        ...
        agimus_franka::computeLowerLimitsJointVelocity(current_state_.q_d), agimus_franka::kMaxJointAcceleration,
        agimus_franka::kMaxJointJerk, velocity_command.dq, current_state_.dq_d, current_state_.ddq_d);
  }
  ...
  if (joint_position_command_low_pass_filter_active_) {
    for (size_t i = 0; i < 7; i++) {
      position_command.q.at(i) =
          agimus_franka::lowpassFilter(agimus_franka::kDeltaT, position_command.q.at(i), current_state_.q_d.at(i),
                                low_pass_filter_cut_off_freq);
    }
  }
  if (joint_position_command_rate_limit_active_) {
    position_command.q =
        agimus_franka::limitRate(agimus_franka::computeUpperLimitsJointVelocity(current_state_.q_d),
                          agimus_franka::computeLowerLimitsJointVelocity(current_state_.q_d),
                          agimus_franka::kMaxJointAcceleration, agimus_franka::kMaxJointJerk, position_command.q,
...
agimus_franka::CartesianVelocities Robot::preProcessCartesianVelocities(
  ...
  agimus_franka::CartesianVelocities filtered_velocity_command = velocity_command;
  if (cartesian_velocity_low_pass_filter_active_) {
    for (size_t i = 0; i < 6; i++) {
      filtered_velocity_command.O_dP_EE.at(i) =
          agimus_franka::lowpassFilter(agimus_franka::kDeltaT, velocity_command.O_dP_EE.at(i),
  ...
  if (cartesian_velocity_command_rate_limit_active_) {
    filtered_velocity_command.O_dP_EE = agimus_franka::limitRate(
        agimus_franka::kMaxTranslationalVelocity, agimus_franka::kMaxTranslationalAcceleration,
        agimus_franka::kMaxTranslationalJerk, agimus_franka::kMaxRotationalVelocity,
        agimus_franka::kMaxRotationalAcceleration, agimus_franka::kMaxRotationalJerk, velocity_command.O_dP_EE,
...
agimus_franka::CartesianPose Robot::preProcessCartesianPose(const agimus_franka::CartesianPose& cartesian_pose) {
  ...
  if (cartesian_pose_low_pass_filter_active_) {
    filtered_cartesian_pose.O_T_EE =
        agimus_franka::cartesianLowpassFilter(agimus_franka::kDeltaT, filtered_cartesian_pose.O_T_EE,
                                       current_state_.O_T_EE_c, low_pass_filter_cut_off_freq);
  }

  if (cartesian_pose_command_rate_limit_active_) {
    filtered_cartesian_pose.O_T_EE =
        agimus_franka::limitRate(agimus_franka::kMaxTranslationalVelocity, agimus_franka::kMaxTranslationalAcceleration,
                          agimus_franka::kMaxTranslationalJerk, agimus_franka::kMaxRotationalVelocity,
                          agimus_franka::kMaxRotationalAcceleration, agimus_franka::kMaxRotationalJerk,
...
void Robot::writeOnce(const std::array<double, 6>& cartesian_velocities) {
  ...
  auto velocity_command = agimus_franka::CartesianVelocities(cartesian_velocities);
...
void Robot::writeOnce(const std::array<double, 6>& cartesian_velocities,
  ...
  auto velocity_command = agimus_franka::CartesianVelocities(cartesian_velocities, elbow_command);
  auto filtered_velocity_command = preProcessCartesianVelocities(velocity_command);
...
void Robot::writeOnce(const std::array<double, 16>& cartesian_pose,
  ...
  auto pose_command = agimus_franka::CartesianPose(cartesian_pose, elbow_command);
