...
class Robot {
 public:
   ...
   */
  virtual agimus_franka::RobotState readOnce();

  /**
   * Return pointer to the agimus_franka robot model object .
 ...
 private:
  ...
  std::unique_ptr<agimus_franka::Robot> robot_;
  std::unique_ptr<agimus_franka::ActiveControlBase> active_control_ = nullptr;
  std::unique_ptr<agimus_franka::Model> model_;
  std::unique_ptr<Model> agimus_franka_hardware_model_;
  ...
  agimus_franka::RobotState current_state_;
};
}  // namespace agimus_franka_hardware
