...
/**
 * This class is a thin wrapper around a @ref agimus_franka::Model and delegates all calls to
 * that
 */
class Model {  // NOLINT(cppcoreguidelines-pro-type-member-init,
 ...
 public:
   ...
   * @return Vectorized 4x4 pose matrix, column-major.
   */
  [[nodiscard]] virtual std::array<double, 16> pose(agimus_franka::Frame frame,
   ...
   * @return Vectorized 7x7 mass matrix, column-major.
   */
  [[nodiscard]] virtual std::array<double, 49> mass(const agimus_franka::RobotState& robot_state) const {
   ...
   * @return Gravity vector.
   */
  [[nodiscard]] virtual std::array<double, 7> gravity(const agimus_franka::RobotState& robot_state) const {
