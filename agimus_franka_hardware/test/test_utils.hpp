...
class MockRobot : public agimus_franka_hardware::Robot {
 public:
  ...
  MOCK_METHOD(void, writeOnce, ((const std::array<double, 7>&)efforts),
              (override));
  MOCK_METHOD(void, writeOnce,
              ((const std::array<double, 6>&)cartesian_velocity), (override));
  MOCK_METHOD(void, writeOnce,
              ((const std::array<double, 6>&)cartesian_velocity,
               (const std::array<double, 2>&)elbow_command),
              (override));
  MOCK_METHOD(void, writeOnce, ((const std::array<double, 16>&)cartesian_pose),
              (override));
  MOCK_METHOD(void, writeOnce,
  ...
  MOCK_METHOD(
      ...
      (override));
  MOCK_METHOD(void, setCartesianStiffness,
              (const agimus_franka_msgs::srv::SetCartesianStiffness::Request::
                   SharedPtr&),
              (override));
  MOCK_METHOD(void, setLoad,
              (const agimus_franka_msgs::srv::SetLoad::Request::SharedPtr&),
              (override));
  MOCK_METHOD(void, setTCPFrame,
  ...
  MOCK_METHOD(
      ...
      (override));
  MOCK_METHOD(void, setForceTorqueCollisionBehavior,
              (const agimus_franka_msgs::srv::SetForceTorqueCollisionBehavior::
                   Request::SharedPtr&),
              (override));
  MOCK_METHOD(void, setFullCollisionBehavior,
              (const agimus_franka_msgs::srv::SetFullCollisionBehavior::
                   Request::SharedPtr&),
              (override));
...
inline auto createHardwareInfo() -> hardware_interface::HardwareInfo {
  ...
  hardware_interface::InterfaceInfo command_effort_interface,
      command_velocity_interface, command_position_interface,
      effort_state_interface, position_state_interface,
