...
from agimus_franka_msgs.action import Move  # type: ignore
...
def generate_test_description():
    ...
    agimus_franka_gripper_description = IncludeLaunchDescription(
    ...
    return (
        LaunchDescription(
            [
                ...
                agimus_franka_gripper_description,
...
class TestStartJointPositions(unittest.TestCase):
    ...
    def test_gripper_position(self, launch_service, agimus_franka_gripper, proc_output):
