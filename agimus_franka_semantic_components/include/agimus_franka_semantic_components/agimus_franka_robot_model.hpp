...
class AgimusFrankaRobotModel
 ...
 public:
   ...
   * @throws Runtime error when state interfaces are not available.
   *
   * @see agimus_franka::Model::coriolis
   */
   ...
   *
   * @throws Runtime error when state interfaces are not available
   * @see agimus_franka::Model::gravity
   */
   ...
   *
   * @throws Runtime error when state interfaces are not available
   * @see agimus_franka::Model::pose
   */
  std::array<double, 16> getPoseMatrix(const agimus_franka::Frame& frame) {
    if (!initialized_) {
      initialize();
    }
   ...
   *
   * @throws Runtime error when state interfaces are not available.
   * @see agimus_franka::Model::bodyJacobian
   */
  std::array<double, 42> getBodyJacobian(const agimus_franka::Frame& frame) {
    if (!initialized_) {
      initialize();
    }
   ...
   *
   * @throws Runtime error when state interfaces are not available.
   * @see agimus_franka::Model::zeroJacobian
   */
  std::array<double, 42> getZeroJacobian(const agimus_franka::Frame& frame) {
    if (!initialized_) {
      initialize();
    }
 ...
 private:
  ...
  agimus_franka_hardware::Model* robot_model_;
  agimus_franka::RobotState* robot_state_;

  std::string arm_id_;

  std::string agimus_franka_state_interface_name_;
  std::string agimus_franka_model_interface_name_;
};
