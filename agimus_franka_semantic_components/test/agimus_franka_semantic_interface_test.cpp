...
#include "agimus_franka_semantic_interface_test.hpp"
...
TEST_F(SemanticComponentInterfaceTest, validate_default_names) {
  ...
  semantic_component_ = std::make_unique<TestableSemanticComponentInterface>(
      component_name_, size_, 0);
  ...
  // Note : Using capacity() for state_interfaces_ as no such interfaces are
  // defined yet
  ...
  std::vector<std::string> interface_names =
      semantic_component_->get_state_interface_names();
...
TEST_F(SemanticComponentInterfaceTest,
       validate_command_interface_default_names) {
  // create 'test_component' with 5 interfaces using default naming
  // e.g. test_component_1, test_component_2 so on...
  semantic_component_ = std::make_unique<TestableSemanticComponentInterface>(
      component_name_, 0, size_);
  ...
  ASSERT_EQ(command_interface_names,
            semantic_component_->command_interface_names_);
...
TEST_F(SemanticComponentInterfaceTest, validate_custom_state_interface_names) {
  ...
  semantic_component_ =
      std::make_unique<TestableSemanticComponentInterface>(size_, 0);
  ...
  ASSERT_TRUE(std::equal(semantic_component_->state_interface_names_.begin(),
                         semantic_component_->state_interface_names_.end(),
...
TEST_F(SemanticComponentInterfaceTest,
  ...
  // as defined in the constructor
  semantic_component_ =
      std::make_unique<TestableSemanticComponentInterface>(0, size_);
  ...
  ASSERT_EQ(command_interface_names.size(), size_);
  ASSERT_EQ(command_interface_names[0],
            semantic_component_->test_name_ + "Command" + "/i5");
  ASSERT_EQ(command_interface_names[1],
            semantic_component_->test_name_ + "Command" + "/i6");
  ASSERT_EQ(command_interface_names[2],
            semantic_component_->test_name_ + "Command" + "/i7");
  ASSERT_EQ(command_interface_names[3],
            semantic_component_->test_name_ + "Command" + "/i8");
  ASSERT_EQ(command_interface_names[4],
            semantic_component_->test_name_ + "Command" + "/i9");
}
...
TEST_F(SemanticComponentInterfaceTest, validate_state_interfaces) {
  ...
  hardware_interface::StateInterface interface_1{component_name_, "1",
                                                 &interface_values[0]};
  hardware_interface::StateInterface interface_3{component_name_, "3",
                                                 &interface_values[1]};
  hardware_interface::StateInterface interface_5{component_name_, "5",
                                                 &interface_values[2]};
...
TEST_F(SemanticComponentInterfaceTest, validate_command_interfaces) {
  ...
  // assign 1.1 to interface_1, 3.3 to interface_3 and 5.5 to interface_5
  hardware_interface::CommandInterface interface_1{component_name_, "1",
                                                   &interface_values[0]};
  hardware_interface::CommandInterface interface_3{component_name_, "3",
                                                   &interface_values[1]};
  hardware_interface::CommandInterface interface_5{component_name_, "5",
                                                   &interface_values[2]};
  ...
  // now call the function to make them in order like interface_names
  semantic_component_->assign_loaned_command_interfaces(
      temp_command_interfaces);
