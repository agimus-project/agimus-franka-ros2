...
class FrankaCartesianVelocityTestFriend
    : public agimus_franka_semantic_components::FrankaCartesianVelocityInterface {
 public:
  explicit FrankaCartesianVelocityTestFriend(const bool elbow_activate)
      : agimus_franka_semantic_components::FrankaCartesianVelocityInterface(elbow_activate) {}
...
class FrankaCartesianVelocityTest : public ::testing::Test {
 ...
 protected:
  ...
  std::unique_ptr<FrankaCartesianVelocityTestFriend> agimus_franka_cartesian_command_friend;
