...
class MoveToStartExampleControllerTest : public ::testing::Test {
 ...
 protected:
  ...
  std::vector<double> joint_q_state_ = {0, -0.785398, 0,       -2.35619,
                                        0, 1.5708,    0.785398};
  ...
  StateInterface joint_1_pos_state_{joint_names_[0], HW_IF_POSITION,
                                    &joint_q_state_[0]};
  StateInterface joint_2_pos_state_{joint_names_[1], HW_IF_POSITION,
                                    &joint_q_state_[1]};
  StateInterface joint_3_pos_state_{joint_names_[2], HW_IF_POSITION,
                                    &joint_q_state_[2]};
  StateInterface joint_4_pos_state_{joint_names_[3], HW_IF_POSITION,
                                    &joint_q_state_[3]};
  StateInterface joint_5_pos_state_{joint_names_[4], HW_IF_POSITION,
                                    &joint_q_state_[4]};
  StateInterface joint_6_pos_state_{joint_names_[5], HW_IF_POSITION,
                                    &joint_q_state_[5]};
  StateInterface joint_7_pos_state_{joint_names_[6], HW_IF_POSITION,
                                    &joint_q_state_[6]};

  // Velocity state interfaces
  StateInterface joint_1_vel_state_{joint_names_[0], HW_IF_VELOCITY,
                                    &joint_dq_state_[0]};
  StateInterface joint_2_vel_state_{joint_names_[1], HW_IF_VELOCITY,
                                    &joint_dq_state_[1]};
  StateInterface joint_3_vel_state_{joint_names_[2], HW_IF_VELOCITY,
                                    &joint_dq_state_[2]};
  StateInterface joint_4_vel_state_{joint_names_[3], HW_IF_VELOCITY,
                                    &joint_dq_state_[3]};
  StateInterface joint_5_vel_state_{joint_names_[4], HW_IF_VELOCITY,
                                    &joint_dq_state_[4]};
  StateInterface joint_6_vel_state_{joint_names_[5], HW_IF_VELOCITY,
                                    &joint_dq_state_[5]};
  StateInterface joint_7_vel_state_{joint_names_[6], HW_IF_VELOCITY,
                                    &joint_dq_state_[6]};
};
